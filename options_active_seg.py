...
class Options():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--init_train_frac', type=float, choices=[0.05, 0.1, 0.15], default=0.05)
        self.parser.add_argument('--annotation_budget', type=float, help="In percentage of points of total dataset", default=0.05)
        self.parser.add_argument('--active_rounds', type=int, default=5)
        self.parser.add_argument('--active_epochs', type=int, help="Number of epochs trained after an active round", default=15)
